...
result = [round(sum(scores) / len(scores), 2) for scores in zip(std1, std2, std3)]
result2 = [round(sum(scores) / len(scores), 2) for scores in zip(*scores)]
print(result)  # ✅ [90.0, 80.0, 70.0]
print(result2)  # ✅ [90.0, 80.0, 70.0]
